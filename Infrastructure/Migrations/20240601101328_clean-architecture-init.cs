...
{
    /// <inheritdoc />
    public partial class cleanarchitectureinit : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    InsuranceTypesId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PoliciesId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_InsuranceTypePolicy", x => new { x.InsuranceTypesId, x.PoliciesId });
                    table.ForeignKey(
